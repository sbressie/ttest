...
# --- 2. MAP HELPER (The replacement for geemap) ---
...
if st.button("🚀 Run Analysis"):
    try:
        ...
        # Hardcoding UKR for the Vida dataset path logic in your previous snippet
